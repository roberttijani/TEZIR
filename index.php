	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<div class="ANASWIRA">
					<a href = "index.php"><img src="images/tezir.png" width="150"></a>
				</div>
			</div>
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															...
															<div class="stars">
															<?php
															$bintang = '<i class="fa fa-star black-star" aria-hidden="true"></i>';
															$rate = $p['rate'];
															
															for($n=1;$n<=$rate;$n++){
																echo '<i class="fa fa-star black-star" aria-hidden="true"></i>';
															};
															?>
															</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Tezir's Lab, Malang Indonesia.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">tezir@gmail.com</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2020 Robert & Wildan Lab. All rights reserved</p>
			</div>
		</div>
